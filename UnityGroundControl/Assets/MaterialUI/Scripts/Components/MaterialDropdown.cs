...
namespace MaterialUI
{
    ...
    public class MaterialDropdown : UIBehaviour, IOptionDataListContainer
    {
        ...
        public class MaterialDropdownEvent2 : UnityEvent<object> { }
        /// <summary>
        ...
        private MaterialDropdownEvent2 m_OnItemSelected2 = new MaterialDropdownEvent2();
        public MaterialDropdownEvent2 onItemSelected2
        {
            get { return m_OnItemSelected2; }
            set { m_OnItemSelected2 = value; }
        }
        /// <summary>
        /// Called when an item is selected. Like UnityEvents, accessible from inspector.
        /// </summary>
        ...
        public void Select(int selectedItem, bool submitted = false)
        {
            ...
            if (m_OnItemSelected2 != null)
            {
                m_OnItemSelected2.Invoke(this);
            }
